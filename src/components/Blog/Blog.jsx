                ...
                <div className="card-body">
                    <div className='flex justify-between'>
                        ...
                        <div className='flex'>
                            ...
                            <label onClick={() => handleBookMark(blog.id)} className="cursor-pointer" ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className="card-actions">
                        <button onClick={() => handleReadMin(blog.id)} className="text-blue-600 underline">Marks as read</button>
                    </div>
                </div>
            </div>
        </div>
